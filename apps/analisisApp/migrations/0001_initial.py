# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-10-14 01:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ccliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analisisApp.cliente')),
                ('hhabitacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analisisApp.habitacion')),
            ],
        ),
        migrations.AddField(
            model_name='cliente',
